...
public class Lista {
     ...
     */
    public void agregarAlFinal(String ruta){
     ...
     */
    public void insertarPorReferencia(Object referencia, String ruta){
        // Define un nuevo nodo.
        Nodo nuevo = new Nodo();
        // Agrega al valor al nodo.
        nuevo.setRuta(ruta);
     ...
     */
    public void insrtarPorPosicion(int posicion, String ruta){
     ...
     * @throws Exception 
     */
    public Object getPosicion( Object referencia) throws Exception{
        // Consulta si el valor existe en la lista.
        if (buscar(referencia)) {
            // Crea una copia de la lista.
            Nodo aux = inicio;
     ...
     */
    public void editarPorReferencia(Object referencia, String ruta){
        // Consulta si el valor existe en la lista.
        if (buscar(referencia)) {
            // Crea ua copia de la lista.
            Nodo aux = inicio;
     ...
     * @param valor nuevo valor para el nodo.
     */
    public void editarPorPosicion(int  posicion , String ruta){
        // Verifica si la posición ingresada se encuentre en el rango
        // >= 0 y < que el numero de elementos del la lista.
        if(posicion>=0 && posicion<tamanio){
    ...
    public void removerPorReferencia(Object referencia){
        ...
        if (buscar(referencia)) {
            ...
            if (inicio.getRuta() == referencia) {
                ...
                // Recorre la lista hasta llegar al nodo anterior 
                // al de referencia.
                while(aux.getsiguente().getRuta() != referencia){
                    aux = aux.getsiguente();
                }
                // Guarda el nodo siguiente del nodo a eliminar.
                Nodo siguiente = aux.getsiguente().getsiguente();
                // Enlaza el nodo anterior al de eliminar con el 
                // sguiente despues de el.
                aux.setsiguente(siguiente);  
            }
    ...
    public void listar(){
        ...
        if (!esVacia()) {
            ...
            while(aux != null){
                ...
                System.out.print(i + ".[ " + aux.getRuta()+ " ]" + " ->  ");
